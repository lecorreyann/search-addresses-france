...
var getAddressesFranceV2_exports = {};
__export(getAddressesFranceV2_exports, {
  default: () => getAddressesFranceV2
});
module.exports = __toCommonJS(getAddressesFranceV2_exports);
var import_getAddressesFromGouvAdresseApi = __toESM(require("../infrastructure/getAddressesFromGouvAdresseApi.js"), 1);
async function getAddressesFranceV2(query) {
  let addresses = [];
...
0 && (module.exports = {});
//# sourceMappingURL=getAddressesFranceV2.js.map
